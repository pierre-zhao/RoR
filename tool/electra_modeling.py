...
class BertModel(object):
  ...
  def __init__(self,
    ...
    orig_hidden_dropout_prob = bert_config.hidden_dropout_prob
    orig_attention_probs_dropout_prob = bert_config.attention_probs_dropout_prob
    ...
    bert_config.hidden_dropout_prob, bert_config.attention_probs_dropout_prob = tf.cond(is_training, true_fn=enable_dropout, false_fn=disable_dropout)
