...
#     with open('/home/user31/notespace/submit/output/data_reanswer/predict.reanswer.detail.json','r') as f:
#         input_data1 = json.load(f)
    ...
    for data,data1 in zip(input_data,input_data1):
        ...
        gamma = 0.9        
        no_answer = gamma*data["no_answer_score"] + (1-gamma)*data1["no_answer_score"]
