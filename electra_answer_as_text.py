...
class QuacPipeline(object):
    ...
    def get_train_examples(self):
        ...
        data_path = os.path.join(self.data_dir, "{0}.answer.best.json".format(self.task_name))
    ...
    def get_dev_examples(self):
        ...
        data_path = os.path.join(self.data_dir, "{0}.dev.answer.best.json".format(self.task_name))
        data_list = self._read_json(data_path)
        example_list = self._get_example(data_list)
        return example_list
    ...
    def process(self,
        ...
        for (example_idx, example) in enumerate(examples):
            ...
            for example_feature in example_features:
                ...
                predict_feature_result.append(predict_in_feature[:self.n_best_size])
